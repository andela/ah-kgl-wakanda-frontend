  ...
  <Router>
    <Switch>
      <Route
        ...
        render={props =>
          !isAuth ? <Signup {...props} /> : <Redirect to={paths.HOME_PATH} />
        }
      />
      ...
      <Route
        ...
        render={props =>
          isAuth ? <Redirect to={paths.HOME_PATH} /> : <Login {...props} />
        }
      />
      ...
      <Route
        exact
        path={paths.UPDATE_PASSWORD_PATH}
      ...
      <Route
        ...
        path="/articles/new"
        render={props =>
          isAuth ? <CreateArticle {...props} /> : <Redirect to="/login" />
        }
      />
